...
#ifndef LMSHAO_LMRTSP_IRTSP_CLIENT_CALLBACK_H
#define LMSHAO_LMRTSP_IRTSP_CLIENT_CALLBACK_H
...
/**
 * @brief RTSP client callback interface
 *
...
#endif // LMSHAO_LMRTSP_IRTSP_CLIENT_CALLBACK_H